...
int main()
{
	// Basic Information
	// 00H
	unsigned int BaseIndexMax;		// Maximum Input Value for Basic CPUID Information
	unsigned int VendorID[3];		// Intel: GenuineIntel
									// AMD: AuthcAMDenti 
	// 01H
	unsigned int ProcSign;			// [3:0]: Steping ID
									// [7:4]: Model
									// [11:8]: Family ID
									// [13:12]: Processor Type, 00:Early OEM; 01:OverDrive;10:MultiProcessor
									// [19:16]: Extended Model ID
									// [27:20]: Extended Family ID
	unsigned int FeaInfo0;			// [7:0]: Brand Index
	...
	unsigned int FeaInfo1_Intel;	// [0]:SSE3, [1]:PCLMULQDQ, [2]:DTES64, [3]:MONITOR
	...
	unsigned int FeaInfo2_Intel;	// [0]:FPU, [1]:VME, [2]:DE, [3]:PSE
	...
	// 02H
	unsigned int CacheTLBInfo_Intel[4];	// Cache and TLB 
	// 03H
	unsigned int ProcSeriNum_Intel[2];	// Processor Serial Number
	// 04H : In FindCache_Intel
	// 07H
	unsigned int SubLeafMax_Intel;	// Reports the maximum input value for supported leaf 7 sub-leaves
	unsigned int Subleaf1_Intel;	// [0]:FSGSBASE, [1]:IA32_TSC_ADJUST MSR, [2]:SGX, [3]:BMI1
	...
	unsigned int SubLeafMax_AMD;	// Reports the maximum input value for supported leaf 7 sub-leaves
	unsigned int SubleafB_AMD;		// [0]:FSGSBASE, [3]:BMI1
									// [5]:AVX2, [7]:SMEP
									// [8]:BMI2, [10]:INVPCID 
									// [18]:RDSEED, [19]:ADX
									...
									// [24]:CLWB
									// [29]:SHA
	unsigned int SubleafC_AMD;		// [2]:UMIP, [3]:PKU
									// [4]:OSPKE, [7]:CET_SS
									// [9]:VAES, [10]:VPCMULQDQ
	// 18H : IN FindCache_Intel
	// Extended Information
	// 80000000H
	unsigned int ExtendIndexMax;	// Maximum Input Value for Extended Function CPUID Information
	// 80000001H
	unsigned int ExtSignC_Intel;	// [0]: LAHF/SAHF
									// [5]: LZCNT
									// [8]: PREFETCHW
	unsigned int ExtSignD_Intel;	// [11]: SYSCALL/SYSRET
	...
	unsigned int ExtSignA_AMD;		// [3:0]: Steping ID
									// [7:4]: Model
									// [11:8]: Family ID
									// [19:15]: Extended Model ID
									// [27:20]: Extended Family ID
	unsigned int ExtSignB_AMD;		// [15:0]: Brand ID
									// [31:28]: Package type
	unsigned int ExtSignC_AMD;		// [0]:LAHF/SAHF, [1]:CMPLEGACY, [2]:SVM, [3]:EXTAPICSPACE
	...
	unsigned int ExtSignD_AMD;		// [0]:FPU, [1]:VME, [2]:DE, [3]:PSE
									// [4]:TSC, [5]:MSR, [6]:PAE, [7]:MCE
	...
	// 80000002H
	unsigned int ProcBrand[12];		// Processor Brand String
	...
	char Vendor[13];
	char Brand[49];
	unsigned int Intel_AMD;			// 1:Intel, 0:AMD
	...
	if (Intel_AMD) {
		...
		printf("SSE3: %d         ", (FeaInfo1_Intel & 0x00000200) >> 9);
